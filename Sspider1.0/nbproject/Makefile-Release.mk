...
${OBJECTDIR}/Conn.o: Conn.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Conn.o Conn.cc

${OBJECTDIR}/Crawler.o: Crawler.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Crawler.o Crawler.cc

${OBJECTDIR}/Parse_TCP.o: Parse_TCP.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Parse_TCP.o Parse_TCP.cc

${OBJECTDIR}/TCPStream.o: TCPStream.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TCPStream.o TCPStream.cc
